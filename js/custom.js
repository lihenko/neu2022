...
function initialize(id) {
	...
	var overlayTitle = 'Wohlfühlkosmetik';

	var locations = [
        //point number 1
        ['Wohlfühlkosmetik Katharina Scheck', 'Am Gries 3, Prien am Chiemsee', 47.85696, 12.34217],
        ];
...
function initializeSatellite(id) {
    ...
    var locations = [
        //point number 1
        ['Wohlfühlkosmetik Katharina Scheck', 'Prien am Chiemsee', 47.8490104, 12.3285826]
        ];
